...
# Support Vector Machine 알고리즘을 구현하고 있는
...
# linearSVC 클래스의 학습이후, the number of iteration 메세지가 나오는 경우 
# 학습이 완료되지 않은 상태이므로 max_iter의 매개변수 값을 조정하여 성능을 높일 수 있습니다.
svm_model = LinearSVC(max_iter=1000000).fit(X_train, y_train)
