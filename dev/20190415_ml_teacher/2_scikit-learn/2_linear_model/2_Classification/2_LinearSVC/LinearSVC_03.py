...
# l1제약조건을 사용하는 경우 정규화 처리를 진행한 데이터의
# 성능이 감수할 수 있음. 
# 너무 0으로 다 수렴해서 그럴수있음. 제약조건이 강한 경우 (c가 작은 경우) 너무 다 0으로가서
# 정규화 후에 성능이 더 나쁨  
...
# zip 뒤의 리스트에 값을 매치 시켜주는 함수.
# penalty="l1" 중요한 값만 사용하는 제약조건. - > 대다수의 데이터가 0으로 수렴함.
